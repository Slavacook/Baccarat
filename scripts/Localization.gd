...
const DATA = {
	"ru": {
		...
		"SETTINGS_STORY": "СЮЖЕТ",
		"SETTINGS_IMMORTALITY": "Бессмертие",
		"SETTINGS_TEST_CARDS_ENABLED": "Включить тестовые карты",
		"SETTINGS_CARD_SETTINGS": "Настройка карт",
		...
		"SETTINGS_BACKGROUND_NOISE_OFF": "Фон. шум выкл",
		"SETTINGS_BACKGROUND_NOISE_LEVEL": "Фон. громкость %d",
	...
	"en": {
		...
		"NO_ACTIVE_BETS": "Place your bets",
		...
		"SETTINGS_STORY": "STORY",
		"SETTINGS_IMMORTALITY": "Immortality",
		"SETTINGS_TEST_CARDS_ENABLED": "Enable test cards",
		"SETTINGS_CARD_SETTINGS": "Card Settings",
		...
		"SETTINGS_BACKGROUND_NOISE_OFF": "Background noise off",
		"SETTINGS_BACKGROUND_NOISE_LEVEL": "Background volume %d",
