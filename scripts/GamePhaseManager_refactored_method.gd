# РЕФАКТОРЕННЫЙ МЕТОД on_action_pressed() - GUARD CLAUSES ВЕРСИЯ
# Копируйте этот метод в GamePhaseManager.gd (строка 196-362)
# БЫЛО: 166 строк, 6+ уровней вложенности
# СТАЛО: ~60 строк основной метод + 5 helper методов, 2-3 уровня вложенности
...
# ═══════════════════════════════════════════════════════════════════════════
# РЕФАКТОРЕННЫЕ МЕТОДЫ (из on_action_pressed)
# Добавить эти методы в конец класса GamePhaseManager
# ═══════════════════════════════════════════════════════════════════════════
