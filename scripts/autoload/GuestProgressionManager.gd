...
const DEFAULT_THRESHOLDS: Dictionary = {
	...
	2: 300,    # 2-й гость при 300 чаевых
	3: 3000,   # 3-й гость при 3000 чаевых
	4: 7000,   # 4-й гость при 7000 чаевых
	5: 15000,  # 5-й гость при 15000 чаевых
	6: 30000   # 6-й гость при 30000 чаевых
}
