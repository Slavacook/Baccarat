...
## Все ставки обработаны (все выигрышные оплачены и все проигрышные собраны, или ставок не было)
## Эмитится когда можно активировать нового гостя (за шаг до начала новой раздачи)
@warning_ignore("unused_signal")
signal all_bets_processed()
...
@warning_ignore("unused_signal")
signal payout_correct(payload: Dictionary)
...
@warning_ignore("unused_signal")
signal payout_wrong(payload: Dictionary)
