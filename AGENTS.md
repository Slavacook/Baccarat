...
├── AGENTS.md              # Документация для Codex
...
- [ ] Документировать события в AGENTS.md
...
- [ ] Обновлён AGENTS.md (новые менеджеры, зависимости)?
...
**Шаг 4: Обновить AGENTS.md** - добавить описание нового менеджера!
